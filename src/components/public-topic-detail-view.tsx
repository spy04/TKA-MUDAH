        ...
        <div className="mt-10">
          <div className="flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-[14px] leading-7 text-[#596983]">
                Kamu bisa lihat daftar latihannya dari sini, tetapi untuk mulai mengerjakan tetap perlu masuk akun siswa.
              </p>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-5 flex items-center gap-2 rounded-[16px] bg-[#f8fbff] px-4 py-3 text-[13px] font-medium text-[#596983]">
                      <Lock className="size-4 shrink-0" />
                      {isPreview
                        ? "Gratis dikerjakan, tetapi wajib login agar progres tersimpan."
                        : "Latihan ini tersedia untuk akun premium."}
                    </div>

                    <div className="mt-5">
                      <Link
                        href={isPreview ? `/masuk?callbackUrl=${encodeURIComponent(`/siswa/latihan/${exercise.id}`)}` : "/daftar"}
                        className={cn(
                          "flex h-[44px] items-center justify-center rounded-[12px] text-[14px] font-bold",
                          isPreview ? "bg-[#2563eb] text-white" : "bg-[#edf8f2] text-[#0f8a63]",
                        )}
                      >
                        {isPreview ? "Masuk untuk Mulai" : "Daftar Premium"}
                      </Link>
                    </div>
                  </article>
                );
