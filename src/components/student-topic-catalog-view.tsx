...
type StudentTopicCatalogViewProps = {
  displayName: string;
...
export function StudentTopicCatalogView({
  displayName,
  dashboardData,
  logoutAction,
}: StudentTopicCatalogViewProps) {
      ...
      <section className="rounded-[28px] border border-[#dce5f4] bg-[#f8faff] px-5 py-5 shadow-[0_24px_40px_-34px_rgba(15,23,42,0.28)] sm:px-6 lg:px-7">
        <div className="max-w-[820px]">
          ...
          <p className="mt-4 max-w-[780px] text-[16px] leading-9 text-[#596983]">
            Temukan beragam materi pembelajaran interaktif dan lanjutkan progres belajarmu dari akun siswa.
          </p>
        </div>
                    ...
                    <div className="px-6 py-6">
                      ...
                      <div className="mt-5 rounded-[16px] bg-[#f8fbff] px-4 py-3 text-[13px] font-medium text-[#596983]">
                        <div className="flex items-center gap-2">
                          ...
                          {isPreview
                            ? "Topik ini punya materi dan latihan yang bisa dibuka dari akun siswa."
                            : "Topik ini butuh upgrade premium untuk akses penuh."}
                        </div>
                      </div>
